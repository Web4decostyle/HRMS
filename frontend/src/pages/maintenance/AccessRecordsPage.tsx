  ...
  return (
    <div className="space-y-4">
      <div className="text-sm text-slate-500">
        Maintenance / <span className="text-slate-700">Access Records</span>
      </div>
      ...
      <section className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
        ...
        <div className="mt-6 flex justify-end">
          <button
            ...
            disabled={!picked}
            onClick={() => {
              // PART 2 backend: call “download personal data” endpoint
              alert(`Will download personal data for: ${picked?.label}`);
            }}
          >
            Search
          </button>
