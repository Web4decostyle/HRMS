...
export default function SystemUsersPage() {
  ...
  return (
    <div className="space-y-6 text-xs">
      ...
      {errorMsg && (
        <div className="rounded-xl border border-green-200 bg-green-50 px-4 py-2 text-[11px] text-green-700">
          {errorMsg}
        </div>
      )}
                      ...
                      <td className="px-4 py-3 border-t border-slate-100">
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            className="h-7 w-7 rounded-full border border-slate-200 flex items-center justify-center bg-white hover:bg-green-50"
                          >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-5">
                  ...
                  <div className="flex flex-col gap-1">
                    <label className={labelCls}>
                      User Role<span className="text-green-500">*</span>
                    </label>
                    <select
                      name="role"
                      value={addForm.role}
