      ...
      <section className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <div className="px-6 py-4">
                    ...
                    >
                      ...
                      <td className="px-3 py-3">
                        <input
                          ...
                          className="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs focus:outline-none focus:ring-1 focus:ring-red-500"
                        />
                      </td>
                      ...
                      {days.map((_, dayIndex) => (
                        <td key={dayIndex} className="px-2 py-3">
                          <input
                            ...
                            className="w-full rounded-lg border border-slate-200 bg-white px-2 py-2 text-xs text-center focus:outline-none focus:ring-1 focus:ring-red-500"
                          />
                        </td>
                      ))}
          ...
          <button
            ...
            className="mt-4 inline-flex items-center gap-2 text-xs font-medium text-slate-600 hover:text-red-600"
          >
