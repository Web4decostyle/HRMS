...
const TimeTopTabs: React.FC = () => {
  ...
  // Close dropdowns when clicking outside the orange bar
  useEffect(() => {
      ...
      <section className="bg-white rounded-xl border border-slate-200 shadow-sm p-4 space-y-4">
        ...
        >
          <div>
            ...
            <input
              type="date"
              className="border border-slate-200 rounded-md px-2 py-1 text-sm focus:outline-none focus:ring-1 focus:ring-orange-500"
              value={periodStart}
